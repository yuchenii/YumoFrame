...
/**
 * Renders the rotating-flow video from a resolved YumoFrame project.
      ...
      {audio?.bgm?.src ? (
        <Sequence from={secondsToFrame(audio.bgm.start ?? 0, fps)} layout="none">
          <Audio
            ...
            volume={audio.bgm.volume ?? 0.2}
            loop={audio.bgm.loop ?? true}
          />
        </Sequence>
      ) : null}
