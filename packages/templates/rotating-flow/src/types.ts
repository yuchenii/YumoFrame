/**
 * Shared project, scene, and kinetic-text types for the rotating-flow Remotion template.
 */
...
/** Full rotating-flow project document consumed by Remotion compositions. */
